...
@error('nombre')
       ...
       <form action="{{ route('tipo_estra.crear') }}" method="POST">     
        @csrf

      <div class="row card-form" style = "height: 25VH; margin:30px">
        ...
        <button class="btn-form" type="submit" style = "margin:10px; margin-left:127px; margin-top:28px">Agregar</button> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <input type="text" name="tipo_columnas"  value="tipoestras" hidden>
          <br>
...
@error('nombre')
        ...
        @enderror
        <form action="{{ route('estra.crear') }}" method="POST">     
        @csrf
  ...
  <tbody>
    ...
    <tr>
      ...
      <a href="{{ route('estra.editar', $item1) }}" class="btn" style="background: #486A8C;">
        ...
        <form action="{{ route('estra.eliminar', $item1)}}" method="POST" class="d-inline">
        @method('DELETE')  
        @csrf
        <button class="btn" style="background: #486A8C;" type="submit">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16" style="color:#EFE6E6">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <label for="name" class = "text">Nombre Columna</label>
          <input type="text" name="nombre" placeholder="Nombre Columna" class="form-control form-gape" value="" >
          <input type="text" name="tipo_columnas"  value="estras" hidden>
          <br>
          <button type="button" class="btn btn-secondary" style = "border-radius:10px" data-dismiss="modal">Close</button>
          <button  class="btn" type="submit"style="background:#486A8C;color:#EFE6E6; font-size: 18px; border-radius:10px">Save changes</button>
          </form>
